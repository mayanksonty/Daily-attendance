...
<head>
	...
	<script type="text/javascript">
		function colorChange(bgcolor){
			document.getElementById("first").style="background:"+bgcolor+";";
		}
	</script>
...
<div class="content">
	...
	<div class="card_container">
		<div class="page_card">
      		...
      		<a href="#" style="border-bottom-left-radius: 0.4em;border-bottom-right-radius: 0.4em;">Generate Report</a>
		</div>
	...
	<div id="display">
		...
		<div class="card_container">
			<div class="page_card" style="background: #e54d66;">
				<a href="#" style="border-radius: 0.4em; border-radius: 0.4em; background: #cc344d;" onclick="colorChange(red)">Export in Excel</a>
			</div>
			<div class="page_card" style="background: #e54d66;">
